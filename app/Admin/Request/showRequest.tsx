...
//     try {
//       const endpoint = newStatus === "approved" ? "approve-request" : "reject-request";
//       await axios.put(
...
//           className={`flex items-center justify-between px-3 py-2 rounded-lg border text-sm font-medium min-w-[120px] transition-all duration-200 hover:shadow-md ${getStatusColor(currentStatus)}`}
//         >
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {requests.map((request) => (
            <div
              key={request._id}
              className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer"

    ...
    return (
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-1 animate-slide-up">
            <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs bg-linear-to-r from-[#1887A1] to-[#0D4C5B] text-white px-3 py-1 rounded-full font-semibold">
            ...
            {progress ? (
                <>
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="text-center">
                                    <span className="text-2xl sm:text-3xl font-bold bg-linear-to-r from-[#1887A1] to-[#0D4C5B] bg-clip-text text-transparent">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                        <div className="bg-linear-to-br from-blue-50 to-blue-100 rounded-xl p-3 hover:scale-105 transition-all duration-300">
                        ...
                        <div className="bg-linear-to-br from-green-50 to-green-100 rounded-xl p-3 hover:scale-105 transition-all duration-300">
                        ...
                        <div className="bg-linear-to-br from-purple-50 to-purple-100 rounded-xl p-3 hover:scale-105 transition-all duration-300">
                ...
                <div className="text-center">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-linear-to-r from-[#1887A1] to-[#0D4C5B] text-white text-sm font-semibold rounded-lg hover:scale-105 transition-all duration-300"
                    >

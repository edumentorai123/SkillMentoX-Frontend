...
//           <h1 className="text-xl sm:text-2xl font-bold text-teal-600">SkillMentorX</h1>
//         </div>
...
//             <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">My Doubts</h1>
//             <p className="text-teal-100 text-sm sm:text-base">Track and manage your questions</p>
//           </header>
...
//               className={`px-4 py-1.5 rounded-full font-medium ${activeFilter === 'All' ? 'bg-white text-teal-600' : 'bg-teal-600 text-white border-2 border-white hover:bg-white hover:text-teal-600'}`}
//             >
//               All
//             </button>
//             <button
//               onClick={() => setActiveFilter('Answered')}
//               className={`px-4 py-1.5 rounded-full font-medium ${activeFilter === 'Answered' ? 'bg-white text-teal-600' : 'bg-teal-600 text-white border-2 border-white hover:bg-white hover:text-teal-600'}`}
//             >
//               Answered
//             </button>
//             <button
//               onClick={() => setActiveFilter('Pending')}
//               className={`px-4 py-1.5 rounded-full font-medium ${activeFilter === 'Pending' ? 'bg-white text-teal-600' : 'bg-teal-600 text-white border-2 border-white hover:bg-white hover:text-teal-600'}`}
//             >
//               Pending
//             </button>
//             <button
//               onClick={() => setActiveFilter('Java Script')}
//               className={`px-4 py-1.5 rounded-full font-medium ${activeFilter === 'Java Script' ? 'bg-white text-teal-600' : 'bg-teal-600 text-white border-2 border-white hover:bg-white hover:text-teal-600'}`}
//             >
//               JavaScript
//             </button>
//           </div>
...
//               <div key={doubt.id} className="bg-white rounded-lg p-4 shadow-md hover:shadow-lg transition">
...
//                   {doubt.status}
//                 </span>
//                 <h3 className="text-gray-800 font-medium mt-3 mb-2 text-sm sm:text-base">{doubt.question}</h3>

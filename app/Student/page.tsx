      ...
      `}>
        ...
        <nav className="px-4 mt-2">
          <ul className="space-y-2">
            {['DashBoard', 'My Doubts', 'Chats', 'Quizzes', 'Course', 'Progress'].map((item, index) => (
              <li key={item}>
                <button 
                  className={`w-full text-left px-4 py-2.5 rounded-lg font-medium transition-all duration-200 text-sm sm:text-base ${
                    index === 0 
          ...
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-1 sm:space-x-2 bg-white bg-opacity-20 rounded-full pl-1.5 sm:pl-2 pr-2 sm:pr-3 py-1 sm:py-1.5 hover:bg-opacity-30 transition-all duration-200 cursor-pointer">
                ...
                <span className="text-black font-semibold text-xs sm:text-base hidden sm:block">Faizy</span>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-5 shadow-xl hover:shadow-2xl transition-all duration-300">
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-3 text-center">
                  <div>
                    ...
                    <div className="text-xs text-gray-500 mb-1 sm:mb-2">Completed</div>
                    <div className="font-bold text-sm sm:text-lg text-gray-800">12/15</div>
                  </div>
                  <div className="border-x border-gray-200">
                    <div className="text-xs text-gray-500 mb-1">Study Days</div>
                    <div className="text-xs text-gray-500 mb-1 sm:mb-2"></div>
                    <div className="font-bold text-sm sm:text-lg text-gray-800">7</div>
                    <div className="text-xs text-gray-500">days</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-500 mb-1">Time Spent</div>
                    <div className="text-xs text-gray-500 mb-1 sm:mb-2"></div>
                    <div className="font-bold text-sm sm:text-lg text-gray-800">12</div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 lg:p-5 shadow-xl hover:shadow-2xl transition-all duration-300">
                ...
                <div className="space-y-2 sm:space-y-3">
                  {[
                    { title: 'Net Workshop', subtitle: 'Live Session', time: '2:00pm', color: 'teal' },
                    { title: 'Assignment Due', subtitle: 'Data Structures', time: '4:30pm', color: 'orange' },
                    { title: 'Mock Interview', subtitle: 'Career preparation', time: 'Tomorrow', color: 'purple' }
                  ].map((event, index) => (
                    <div key={index} className="bg-gradient-to-r from-gray-100 to-gray-200 rounded-lg sm:rounded-xl p-2 sm:p-3 hover:from-teal-50 hover:to-cyan-50 transition-all duration-200">
